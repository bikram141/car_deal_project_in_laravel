            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.addbrand') }}" class="btn btn-dark float-right btn-sm">Add
                            brand</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <table id="userTable" class="table table-responsive table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('carbrands/'.$item->Image) }}" width="100" height="100" alt="Image">
                                    </td>
                                    
                                    <td>
                                        <form class="deleteForm float-left"
                                            action="{{ url('/admin/deletebrand',$item->id) }}" method="post">
